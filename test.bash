...
echo  -e "$bold_orange bold_orange"

echo  -e "$underline_black         underline_black"  
echo  -e "$underline_red           underline_red"
echo  -e "$underline_green         underline_green"
echo  -e "$underline_yellow        underline_yellow"
echo  -e "$underline_blue          underline_blue"
echo  -e "$underline_purple        underline_purple"
echo  -e "$underline_cyan          underline_cyan"
echo  -e "$underline_white         underline_white"
echo  -e "$underline_orange        underline_orange"

echo  -e "$background_black        background_black"
echo  -e "$background_red          background_red"
echo  -e "$background_green        background_green"
echo  -e "$background_yellow       background_yellow"
echo  -e "$background_blue         background_blue"
echo  -e "$background_purple       background_purple"
echo  -e "$background_cyan         background_cyan"
echo  -e "$background_white        background_white"
echo  -e "$background_orange       background_orange"

echo  -e "$normal normal"
echo  -e "$reset_color reset_color"
